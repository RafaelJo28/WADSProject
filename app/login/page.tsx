    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden"
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-purple-300 text-sm mt-1 tracking-widest uppercase">Welcome Back</p>
        </div>
        ...
        <div className="rounded-2xl p-8 border border-purple-900/40 backdrop-blur-md"
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-medium text-white text-sm flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 active:scale-95 disabled:opacity-50"
            style={{
